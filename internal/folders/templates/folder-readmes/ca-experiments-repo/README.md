...
scratch worktree but isn't ready to live under `ca-platform-repo/` or
`cm-product-repo/` yet, this is the home.
...
If you've added sub-projects under `ca-experiments-repo/` outside the manifest,
