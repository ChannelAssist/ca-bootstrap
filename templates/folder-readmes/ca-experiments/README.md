...
contents without an explicit confirmation prompt. See the [safety contract](https://github.com/ChannelAssist/ca-bootstrap/blob/main/docs/commands.md) for the full rules.
